...
public class FoodBookingPlatformApplication {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(
                List.of("http://localhost:5173", "http://localhost:5174", "https://restaurant-booking-api-f979.onrender.com", "https://skedeat.site"));
    ...
    public static void main(String[] args) {
        SpringApplication.run(FoodBookingPlatformApplication.class, args);
    }
