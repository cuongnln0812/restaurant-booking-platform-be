...
CREATE TABLE `ads` (
  ...
  `type` enum('AREA','BANNER','FLASH_SALE') NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ads_registration`
--

DROP TABLE IF EXISTS `ads_registration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ads_registration` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `created_by` varchar(255) NOT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_by` varchar(255) DEFAULT NULL,
  ...
  `status` enum('ACTIVE','DISABLED','EXPIRE','INACTIVE') NOT NULL,
  `ads_id` bigint NOT NULL,
  `location_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKeymobo14nqb7jif1vjf01r72u` (`ads_id`),
  KEY `FKphdwgun7lwfpbl8ao2uvn23ee` (`location_id`),
  CONSTRAINT `FKeymobo14nqb7jif1vjf01r72u` FOREIGN KEY (`ads_id`) REFERENCES `ads` (`id`),
  CONSTRAINT `FKphdwgun7lwfpbl8ao2uvn23ee` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `food` (
  ...
  KEY `FK6fc4clols2o7ouxdajtureutf` (`location_id`),
  CONSTRAINT `FK6fc4clols2o7ouxdajtureutf` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
...
DROP TABLE IF EXISTS `food_booking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `food_booking` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKc4e70le056ti997jg1puued2m` (`food_id`),
  KEY `FK1910b54jybv82cw1grjyy5ofn` (`booking_id`),
  CONSTRAINT `FK1910b54jybv82cw1grjyy5ofn` FOREIGN KEY (`booking_id`) REFERENCES `location_booking` (`id`),
  CONSTRAINT `FKc4e70le056ti997jg1puued2m` FOREIGN KEY (`food_id`) REFERENCES `food` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `location` (
  ...
  `description` text NOT NULL,
  `geo_hash_code` varchar(255) NOT NULL,
  `image` mediumtext NOT NULL,
  `latitude` double NOT NULL,
  `longitude` double NOT NULL,
  `name` varchar(255) NOT NULL,
  `on_banner` int NOT NULL,
  `on_sale` int NOT NULL,
  `on_suggest` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FKl1q5ppxfqj7yd1hd426c1f6j1` (`brand_id`),
  KEY `FKeua4vn06qu0iq9d32qnmuhqkl` (`user_id`),
  CONSTRAINT `FKeua4vn06qu0iq9d32qnmuhqkl` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKl1q5ppxfqj7yd1hd426c1f6j1` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `location_booking` (
  ...
  `phone` varchar(255) NOT NULL,
  `status` enum('CANCELLED','CONFIRMED','DRAFT','FAILED','PENDING','SUCCESSFUL') NOT NULL,
  `location_id` bigint NOT NULL,
  `promotion_id` bigint DEFAULT NULL,
  `user_id` bigint NOT NULL,
  `voucher_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKq2q72dlbl4emhr8mlewpo5cb0` (`location_id`),
  KEY `FKejvqpinbktnxxjx0qisd7p2wx` (`promotion_id`),
  KEY `FK1llxs3u13p4d0ejxiujaenmr6` (`user_id`),
  KEY `FKirulkk59geycobnq481fkaq57` (`voucher_id`),
  CONSTRAINT `FK1llxs3u13p4d0ejxiujaenmr6` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKejvqpinbktnxxjx0qisd7p2wx` FOREIGN KEY (`promotion_id`) REFERENCES `promotion` (`id`),
  CONSTRAINT `FKirulkk59geycobnq481fkaq57` FOREIGN KEY (`voucher_id`) REFERENCES `voucher` (`id`),
  CONSTRAINT `FKq2q72dlbl4emhr8mlewpo5cb0` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
...
CREATE TABLE `location_category` (
  ...
  `location_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK2mnvq127a66fnaq3w9mkgmst0` (`category_id`),
  KEY `FK682ake3h6rwo9hw464at710ax` (`location_id`),
  CONSTRAINT `FK2mnvq127a66fnaq3w9mkgmst0` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
  CONSTRAINT `FK682ake3h6rwo9hw464at710ax` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `location_feedback`
--
...
CREATE TABLE `location_feedback` (
  ...
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK7hjnu87wyamu503xd71iy3k1s` (`booking_id`),
  KEY `FKjya27agb3b88m66lth1sk0kmm` (`user_id`),
  CONSTRAINT `FK7hjnu87wyamu503xd71iy3k1s` FOREIGN KEY (`booking_id`) REFERENCES `location_booking` (`id`),
  CONSTRAINT `FKjya27agb3b88m66lth1sk0kmm` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `location_tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK3v8cy6pwhs2ful50h2jirsx2g` (`location_id`),
  KEY `FKgrpnco0g0npewc87e8he3oj5w` (`tag_id`),
  CONSTRAINT `FK3v8cy6pwhs2ful50h2jirsx2g` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  CONSTRAINT `FKgrpnco0g0npewc87e8he3oj5w` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `monthly_commission_payments`
--

DROP TABLE IF EXISTS `monthly_commission_payments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `monthly_commission_payments` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `package_ads`
--

DROP TABLE IF EXISTS `package_ads`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `package_ads` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `package_id` bigint NOT NULL,
  `ads_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKsj2a6qyjtqttfex0c1by4jtw` (`package_id`),
  KEY `FKamt6ru8fkkbd3hjoioaqk7fvk` (`ads_id`),
  CONSTRAINT `FKamt6ru8fkkbd3hjoioaqk7fvk` FOREIGN KEY (`ads_id`) REFERENCES `ads` (`id`),
  CONSTRAINT `FKsj2a6qyjtqttfex0c1by4jtw` FOREIGN KEY (`package_id`) REFERENCES `package` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `package_registration` (
  ...
  `location_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK8c89vdt966bplyhy2f0jw8y5t` (`package_id`),
  KEY `FKwncm24lpg8qcvwg73hpnubnm` (`location_id`),
  CONSTRAINT `FK8c89vdt966bplyhy2f0jw8y5t` FOREIGN KEY (`package_id`) REFERENCES `package` (`id`),
  CONSTRAINT `FKwncm24lpg8qcvwg73hpnubnm` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_history` (
  ...
  `modified_by` varchar(255) DEFAULT NULL,
  `modified_date` datetime(6) DEFAULT NULL,
  `status` enum('NEED_CONFIRMATION','PAID','UNPAID') NOT NULL,
  `total_amount` float NOT NULL,
  `booking_id` bigint NOT NULL,
  `method_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK2ch6cj2gtpx03uysa8yr0jbby` (`booking_id`),
  KEY `FK2n4p3sn0jocya4ovttjlkvwii` (`method_id`),
  CONSTRAINT `FK2ch6cj2gtpx03uysa8yr0jbby` FOREIGN KEY (`booking_id`) REFERENCES `location_booking` (`id`),
  CONSTRAINT `FK2n4p3sn0jocya4ovttjlkvwii` FOREIGN KEY (`method_id`) REFERENCES `payment_method` (`id`)
...
--
-- Table structure for table `payos_transaction`
--

DROP TABLE IF EXISTS `payos_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `payos_transaction` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `account_number` varchar(255) NOT NULL,
  `amount` int NOT NULL,
  `code` varchar(255) NOT NULL,
  `counter_account_bank_id` varchar(255) DEFAULT NULL,
  `counter_account_bank_name` varchar(255) DEFAULT NULL,
  ...
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKjraq6vfl91hspvg77eupxv4gt` (`order_code`),
  KEY `FKrkxkmswokhykxspngnyabhxhe` (`user_id`),
  CONSTRAINT `FKrkxkmswokhykxspngnyabhxhe` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `point_transaction` (
  ...
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKjhtvgsj6ss86cwmvvu1w8pube` (`user_id`),
  CONSTRAINT `FKjhtvgsj6ss86cwmvvu1w8pube` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `report` (
  ...
  `status` bit(1) NOT NULL,
  `answerer_id` bigint DEFAULT NULL,
  `reporter_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKoshaxns5c1p37k5femj33l13a` (`answerer_id`),
  ...
  CONSTRAINT `FKoshaxns5c1p37k5femj33l13a` FOREIGN KEY (`answerer_id`) REFERENCES `user` (`id`),
  CONSTRAINT `report_chk_1` CHECK ((`report_type` between 0 and 4))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `system_blog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `system_blog` (
  ...
  `status` enum('ACTIVE','DISABLED','INACTIVE','PENDING') NOT NULL,
  `summary` mediumtext NOT NULL,
  `title` varchar(255) NOT NULL,
  `author_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK3wcm02hso1vq08wck4jpquqss` (`author_id`),
  CONSTRAINT `FK3wcm02hso1vq08wck4jpquqss` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `working_hour` (
  ...
  `location_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKtqv7ui4nke4skq9a472burm5i` (`location_id`),
  CONSTRAINT `FKtqv7ui4nke4skq9a472burm5i` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
...
-- Dump completed on 2024-10-29 23:11:11
